...
class App(tk.Tk):
    def __init__(self, title, size):
        ...
        if MEAS_TAB_DBG:
            ...
            self.geometry(f'{size[0]}x{size[1]-44}')
...
class MeasurementFrame(ttk.Frame):
    ...
    def buildFrame(self):
        ...
        measFrm.place(x=0, rely=0.05, relwidth=.7, relheight=.9)
        btnFrm.place(relx=0.7, rely=0.15, relwidth=.3, relheight=.6)
...
if __name__ == "__main__":
    ...
    app = App('Digital Power Monitoring (DPM) Dashboard App', (640, 400))
