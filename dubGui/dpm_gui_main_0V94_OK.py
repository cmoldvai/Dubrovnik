...
class ConfigFrame(ttk.Frame):
    ...
    def __init__(self, parent=None, DEBUG=False):
        ...
        self.DEBUG = DEBUG
        self.comm = None
        self.rshunt_var = tk.DoubleVar()  # used in Rshunt value entry box
        self.chk_var = tk.IntVar()
    ...
    def buildFrame(self):
        ...
        # No need for the 'Save' button. It is in the Menu
        # self.btn_apply = ttk.Button(
        #     self, text='Save Config.', width=10, command=comFrm.saveConfig)
        # self.btn_apply.grid(
        ...
        self.ent_rshunt.bind('<KeyRelease>', self.validate_rshunt_val)  # must use this otherwise it will show up in Entry
    ...
    def validate_rshunt_val(self, event):
        self.ent_rshunt.delete(0, 'end')  # clear the key stuck in the buffer after the <KeyRelease> event
        self.rshunt_var.set(dp.rshunt)  # write back the original value
