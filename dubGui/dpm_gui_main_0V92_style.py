...
class App(tb.Window):
    ...
    # *******************************
        ...
        y_mF = 280
        if MEAS_TAB_DBG:
            measFrm.config(width=580, height=y_mF+40,
                           borderwidth=4, relief='ridge')
        else:
            measFrm.config(width=580, height=y_mF,
                           borderwidth=2, relief='flat')
    ...
    # ***************************
        ...
        stsBar = ttk.Label(stsFrm, text='Not connected',
                           relief='sunken', anchor='w', font=('Helvetica', 9))
        # font=('Calibri', 9)
...
class MeasurementFrame(ttk.Frame):
    ...
    def buildFrame(self):
        ...
        self.vshunt_lbl = ttk.Label(
            self, text="0", width=20, relief='sunken', anchor='e', font=('Calibri', 12))
        # width=20, foreground='black', background='#f8f8f8')
        ...
        self.btn_start_meas = ttk.Button(
            self, text='START', command=self.start_stop, bootstyle='success')  # removed font=('Calibri bold', 18),
    ...
    def start_stop(self):
        ...
        if dp.mode == 0 or dp.mode == 4:
            ...
            self.meas_in_progress = False
            self.btn_start_meas.config(text='START', bootstyle='success')
    ...
    def get_a_measurement(self, get_vs, get_vb, get_i, get_p):
        ...
        if get_vb:
            ...
            if v_b > dp.vbus_range_tbl[dp.brng]:
                ...
                self.vbus_lbl.config(foreground='#aaaaaa')
...
class ConfigFrame(ttk.Frame):
    ...
    def buildFrame(self):
        ...
        self.cfg_reg_lbl.config(
            relief='groove', width=24, font=('Calibri', 11))
